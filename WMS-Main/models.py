...
class User(UserMixin, db.Model):
    ...
    can_create_stock = db.Column(db.Boolean, default=False)
    can_create_order = db.Column(db.Boolean, default=False)
    can_transfer_stock = db.Column(db.Boolean, default=False)
    can_transfer_batch = db.Column(db.Boolean, default=False)
    can_mass_transfer = db.Column(db.Boolean, default=False)
    can_bulk_transfer = db.Column(db.Boolean, default=False)
    can_add_sku = db.Column(db.Boolean, default=False)
    can_view_orders = db.Column(db.Boolean, default=False)  # ← new
    can_cycle_count = db.Column(db.Boolean, default=False)  # ← new
