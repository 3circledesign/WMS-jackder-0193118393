...
@login_required
@permission_required('can_add_sku')
def add_sku_html():
    if request.method == 'POST':
...
@login_required
@permission_required('can_create_stock')
def create_stock():
    if request.method == 'POST':
...
@login_required
@permission_required('can_create_racking')
def add_racking():
...
@login_required
@permission_required('can_transfer_stock')
...
@login_required
@permission_required('can_transfer_batch')
...
@login_required
@permission_required('can_create_order')
def create_order():
    data = request.get_json()
